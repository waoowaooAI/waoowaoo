...
export function usePromptStageActions({
  ...
  const isShotTaskRunning = useCallback((shot: ProjectShot) => {
    return Boolean((shot as ProjectShot & { imageTaskRunning?: boolean }).imageTaskRunning)
  }, [])
