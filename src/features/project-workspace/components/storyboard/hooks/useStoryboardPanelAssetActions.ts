...
import { Character, Location, ProjectClip, ProjectStoryboard } from '@/types/project'
...
interface UseStoryboardPanelAssetActionsProps {
  ...
  locations: Location[]
  localStoryboards: ProjectStoryboard[]
  ...
  regeneratePanelImage: (panelId: string, count?: number, force?: boolean, referencePanelIds?: string[], extraImageUrls?: string[]) => Promise<void>
  modifyPanelImage: (
    storyboardId: string,
    panelIndex: number,
    prompt: string,
