...
import VoiceLineList from '@/features/project-workspace/components/voice-stage/VoiceLineList'
import VoiceControlPanel from '@/features/project-workspace/components/voice-stage/VoiceControlPanel'
import SpeakerVoiceBindingDialog from '@/features/project-workspace/components/voice/SpeakerVoiceBindingDialog'
import type {
  Character,
